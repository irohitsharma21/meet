...
async def _ensure_indexes() -> None:
    ...
    try:
        ...
        # ── conversations ─────────────────────────────────────────────
        conversations = mongodb.db["conversations"]
        await conversations.create_indexes([
            IndexModel([("meeting_id", ASCENDING)], unique=True, name="idx_conv_meeting_id"),
            IndexModel([("created_by", ASCENDING)], name="idx_conv_created_by"),
            IndexModel([("timestamp", ASCENDING)], name="idx_conv_timestamp"),
        ])
